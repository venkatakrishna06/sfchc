        ...
        <div class="row align-items-center">
          <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
            ...
            <p class="text-center">
          	...
          	<input class="btn btn-tango py-3 px-8" type="submit" name="enc_aes" value="Use AES"> <br> <br>
            	<input class="btn btn-tango py-3 px-8" type="submit" name="enc_des" value="Use DES"> <br><br>
